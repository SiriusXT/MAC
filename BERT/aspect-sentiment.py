...
parser.add_argument('--dataset_name', type=str, default='Arts_Crafts_and_Sewing_5',
                    help='dataset name')
parser.add_argument('--dataset_path', type=str, default='../data/Arts_Crafts_and_Sewing_5/Arts_Crafts_and_Sewing_5.json',
...
def save_sentence_feat(params):
    ...
    with open(r'X:\workspace\datasets\Amazon\@aspect\art\sentiment2id.json', 'r') as f:
